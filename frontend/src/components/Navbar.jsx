      ...
      <nav className="navbar  shadow">
        <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          ...
          <div>
            ...
            >
              <ul className="items-center justify-center space-y-8 p-3 md:flex md:space-x-6 md:space-y-0">
                <li className="text-gray-600 hover:text-blue-600 text-right pr-3">
                  <Link to="/">Home</Link>
                </li>
                <li className="text-gray-600 hover:text-blue-600 text-right pr-3">
                  <Link to="/recipecards">Randomize</Link>
                </li>
                <li className="text-gray-600 hover:text-blue-600 text-right pr-3">
                  <Link to="/about">Favorite</Link>
                </li>
                <li className="text-gray-600 hover:text-blue-600 text-right pr-3">
                  <Link to="/favorites">About Us</Link>
                </li>
